...
tokenizer = dict(
    ...
    trust_remote_code=True,
    type='transformers.AutoTokenizer.from_pretrained')
train_cfg = dict(max_epochs=75, type='xtuner.engine.runner.TrainLoop')
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            data_files=dict(train='./Hod_single_conversations.json'),
            path='json',
...
warmup_ratio = 0.03
weight_decay = 0
work_dir = './work_dirs/internlm2_chat_7b_qlora_hod_single'
